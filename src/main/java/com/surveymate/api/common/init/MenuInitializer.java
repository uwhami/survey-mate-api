...
public class MenuInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List<Menu> menuList = Arrays.asList(
                ...
                new Menu("MN001002000000", "MN003000000000", "내가 만든 설문", "My Surveys", "설문조사 목록", "/survey/question/list", MemberRole.USER, 2, "Y"),
                new Menu("MN001003000000", "MN003000000000", "내가 응답한 설문", "My Responses", "내 응답 목록", "/survey/response/list", MemberRole.USER, 3, "Y"),
