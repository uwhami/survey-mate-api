...
public interface SurveyQuestionMstRepository extends JpaRepository<SurveyQuestionMst, String> {
    ...
    @Query("SELECT new com.surveymate.api.domain.survey.dto.SurveyResponseForm(m.sqMstId, m.title, d.id.questionDtlOrder, d.questionText, s.id.questionSdtlOrder, s.optionText) " +
    ...
    List<SurveyResponseForm> getSurveyWithDetails(@Param("surveyUrl") String surveyUrl);
